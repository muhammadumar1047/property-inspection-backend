...
namespace PropertyInspection.Application.Services
{
    public class SearchService : ISearchService
    {
        ...
        public async Task<SearchResultGroupedDto> SearchAsync(string query, Guid? agencyId)
        {
            ...
            return new SearchResultGroupedDto
            {
        ...
        public async Task<List<SearchPropertyDto>> SearchPropertyAsync(string query, Guid? agencyId)
        {
            var tenantAgencyId = _tenantAgencyResolver.ResolveAgencyId(agencyId);
            var properties = await _unitOfWork.Properties.GetAsync(
                predicate: p =>
            ...
            return _mapper.Map<List<SearchPropertyDto>>(properties)
                .OrderBy(r => r.Address)
                .ToList();
        }
    }
