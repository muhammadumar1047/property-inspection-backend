...
namespace PropertyInspection.Application.IServices
{
    public interface IS3Service
    {
        ...
        Task<PropertyInspection.Shared.ServiceResponse<PropertyInspection.Shared.DTOs.SignatureUploadUrlResponse>> GeneratePresignedUploadUrlWithKeyAsync(string folder, string fileName, string contentType);
